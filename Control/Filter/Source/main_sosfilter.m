%% SOS Filter Compilation and Testing
% J.Currie April 2023
clc
clear
clear mxCSOSFilter mxSOSFilter

mex -v Control/Filter/Source/mxSOSFilter.cpp Control/Filter/Source/sosfilter.cpp Control/Filter/Source/csosfilter.c Common/Source/mexHelpers.cpp -I.
movefile('mxSOSFilter.mexw64','Control/Filter/mxSOSFilter.mexw64','f')
...
mxSOSFilter('Init',sosMatrix,sosGain)
[y2,status] = mxSOSFilter('Update',u);
status
